...
//d3.select(window).on('resize', console.log(window.innerWidth))
  ...
  function drawBarChart2(attrName, indexArray, innerWidth=400) {
...
function drawCharts() {
    ...
    drawBarChart2("age", [ageIndex0]);
    addSeriesStats("age", ageMedianCat, null, null, prefix = "Median: ", suffix = " years");
    drawBarChart2("ethnicity", [ethnicityIndex0]);
    drawBarChart2("children", [childrenIndex0]);
    addSeriesStats("children", childrenNonZeroPct, null, null, prefix = "Child present: ", suffix = "%");
    drawBarChart2("education", [educationIndex0]);
    drawBarChart2("income", [incomeIndex0], width=610);
